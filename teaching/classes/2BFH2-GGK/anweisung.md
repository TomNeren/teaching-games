...
**C) Aufgabengestaltung**
- Ein Kompetenzniveau (C) für alle SuS
- Scaffolding eingebaut (Satzanfänge, Wortbanken) — hilft schwächeren, stört stärkere nicht
- Offene Aufgabenformate erlauben unterschiedliche Vertiefungsgrade
...
**Scaffolding**: [Eingebaute Hilfen für alle]
