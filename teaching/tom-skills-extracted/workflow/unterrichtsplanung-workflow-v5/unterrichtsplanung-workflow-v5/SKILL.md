...
description: Strukturierter 2-Phasen-Workflow für Unterrichtsplanung mit 6 Kernprinzipien - Roter Faden (Story-Telling), Hybrid Chat/Cowork, Textformat-Abfrage, Sequentielle Planung, ComfyUI-Automation, SKILL-PFLICHT-CHECK. Enthält HANDOVER_TEMPLATE, COWORK_PROMPT, STUNDEN_CHECKLISTE und METHODEN_HISTORIE Templates.
---
...
**Version:** 5.0.0
**Stand:** 27.01.2026
**Changelog:** NEUES Kernprinzip #6 (SKILL-PFLICHT-CHECK), v3-Skill-Referenzen, erweiterte Trigger-Dokumentation, implizite Trigger für alle Dokumenttypen
...
| **5.0** | **27.01.2026** | **6. Kernprinzip: SKILL-PFLICHT-CHECK, v3-Skill-Referenzen, erweiterte Trigger-Dokumentation, explizite Skill-Referenzen im Handover** |
